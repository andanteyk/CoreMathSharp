...
public class Asinh
{
    ...
    public void TestDoubles()
    {
        ...
        {
            double expected = Math.Asinh(x);
            double actual = StrictMath.Asinh(x);
    ...
    public void Random()
    {
        ...
        for (int i = 0; i < 1024 * 1024; i++)
        {
            ...
            double expected = Math.Asinh(x);
            double actual = StrictMath.Asinh(x);
            double ulp = Math.Max(Math.BitIncrement(actual) - actual, actual - Math.BitDecrement(actual)) * 2;
    ...
    {
        string path = "../../../Binary64/asinh.txt";

        StrictMath.Asinh(2.718281828459045);
