...
public class LGammaF
{
    ...
    public void TestFloats()
    {
        ...
        {
            float expected = MathF.LGammaF(x);
            float actual = StrictMathF.LGammaF(x);
    ...
    {
        string path = "../../../Binary32/lgammaf.txt";
        ...
        foreach (var line in File.ReadLines(path))
        {
            ...
            int b = (int)uint.Parse(parsed[2], NumberStyles.HexNumber);

            (float actualValue, int actualSign) = StrictMathF.LGamma(x);
