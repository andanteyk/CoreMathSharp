...
public class Log10P1F
{
    ...
    public void TestFloats()
    {
        ...
        {
            float expected = float.Log10P1(x);
            float actual = StrictMathF.Log10P1(x);
    ...
    public void Random()
    {
        ...
        {
            float x = rng.NextFloat(0.0f, 1000.0f);
    ...
    {
        string path = "../../../Binary32/log10p1f.txt";
